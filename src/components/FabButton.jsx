...
function handleFabutton(){
  ...
  return (
    <div className="flex justify-end px-5 py-2">
      <button  className="flex cursor-pointer items-center bg-white justify-center w-16 h-16 border text-white text-2xl font-bold rounded-full shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 ">
        <Help/>
      </button>
    </div>
  )
